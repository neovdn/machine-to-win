"""Profile one combo on full 7-month dataset."""
import sys, os, time
...
print(f"FULL 7mo dataset: {elapsed:.2f}s, trades={summary['total_trades']}")
print(f"Estimated for 192 combos on full: {elapsed*192:.0f}s = {elapsed*192/60:.1f} min")
